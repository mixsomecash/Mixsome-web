  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full xl:px-10 pb-10 xl:flex xl:mt-8">
        <div className="xl:w-2/3 mr-5">
          ...
          <div className="xl:flex">
            <div className="text-20 leading-26 font-sans xl:text-32 xl:leading-42">Defi Crab</div>
      ...
      <div className="my-5 items-center pb-20 xl:flex">
        {renderCard({
          title: 'Swap DAI to CDAI - Compound.',
          left: {
            icons: [Currency.DAI],
            value: investValue || 0,
          },
          center: { value: 0.02 || 0 },
          right: { icons: [Currency.CompoundDai], value: investValue! * 0.02 || 0 },
        })}
        ...
        {renderCard({
          ...
          left: {
            icons: [Currency.CompoundDai],
            value: investValue! * 0.02 || 0,
          },
          center: { value: 5.01 },
          right: { icons: [Currency.DAI, Currency.Compound], value: investValue! * 1.01 },
        })}
        ...
        {renderCard({
          ...
          left: {
            icons: [Currency.DAI, Currency.Compound, Currency.MixsomeCoin],
            value: investValue! * 1.01,
          },
          center: { value: investValue! * 1.1055 || 0 },
          right: { icons: [Currency.DAI], value: investValue! * 1.01 * 1.1055 },
        })}
      </div>
